...
<?php include "navigation.html" ?>
	<div class="container-fluid">
		<div class="container box">
			...
			<div class="card-body">
				<form class="myform" action="edit_staff.php" method="post">	

					<div class="form-group">
						<div class="form-row">
							<div class="col-md-4">
								<div class="form-label-group">
									<input type="text" name="firstname" id="firstname" class="form-control" placeholder="First name" required="required" maxlength="15" value="<?php echo $firstname ?>" autofocus="autofocus">

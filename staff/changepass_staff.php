<?php
  ...
  $query1 ="SELECT * FROM staff_info WHERE username = '$username'";
	  ...
	  $md5_password = md5($new_password);
		...
		if ($password != $md5_password) {
			...
			if(mysqli_query($conn, $select_query)){
			  ...
			  $update_query = "UPDATE staff_info SET password = '$md5_password' WHERE username = '$username' ";
	...
	<div class="container box">
		...
		<form class="my-form" method="POST" action="#">
			<div class="form-group">
				...
				<input type="password" class="form-control" name="new_password" id="exampleInputNewPassword" placeholder="New password" equired minlength="8" maxlength="10" autofocus="autofocus">

				<label for="exampleInputN_Password">Retype new Password</label>
				<input type="password" class="form-control" name="c_password" id="exampleInputN_Password" placeholder="Retype new Password" required minlength="8" maxlength="10">
				</div>          
			</div>
		<br>
		<br>

...
$columns = array('username', 'firstname', 'middlename', 'lastname', 'city_municipality', 'address', 'email', 'active');
...
if(isset($_POST["search"]["value"]))
{
 ...
 OR city_municipality LIKE "%'.$_POST["search"]["value"].'%"
...
if ($row["active"] == "1") {
 ...
 $sub_array = array();
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="user_name">' . $row["username"] . '</div>';
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="middlename">' . $row["middlename"] . '</div>';
  ...
  $sub_array[] = '<div class="update" data-id="'.$row["id"].'" data-column="city_municipality">' . $row["city_municipality"] . '</div>';

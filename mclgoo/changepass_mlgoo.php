<?php
  ...
  $query1 ="SELECT * FROM mlgoo_clgoo WHERE username = '$username'";
	 ...
	 // $old_password = $_POST['old_password'];   
	  ...
	  $md5_password = md5($new_password);
		...
		if($new_password == $c_password){
		  $select_query = "SELECT * FROM mlgoo_clgoo";   
          ...
          if ($password != $md5_password) {
			...
			if(mysqli_query($conn, $select_query)){
			  ...
			  $update_query = "UPDATE mlgoo_clgoo SET password = '$md5_password' WHERE username = '$username' ";
	...
	<div class="container box">
		...
		<form class="my-form" method="POST" action="#">
			<div class="form-group">
				...
				<input type="password" class="form-control" name="old_password" id="NewPassword" placeholder="Old password" equired minlength="8" maxlength="10" autofocus="autofocus">

				<label for="NewPassword">New Passwords</label>
				<input type="password" class="form-control" name="new_password" id="NewPassword" placeholder="Enter new password" equired minlength="8" maxlength="10" autofocus="autofocus">

				<label for="N_Password">Confirm Passwords</label>
				<input type="password" class="form-control" name="c_password" id="N_Password" placeholder="Enter Password" required minlength="8" maxlength="10">
				</div>          
			</div>
		<br>
		<br>
